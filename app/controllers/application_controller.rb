class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    update_attrs = [:email, :password, :password_confirmation, :remember_me, :street_address, :city, :state, :zip_code, :phone, :website, :facebook, :instagram, :youtube, :twitter, :avatar, :avatar_cache, :remove_avatar]
